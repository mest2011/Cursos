...
namespace ByteBank.SistemaAgencia
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
            new ContaCorrente(321, 515645646),
            null,
            new ContaCorrente(565, 785785787),
            new ContaCorrente(524, 452452544),
            new ContaCorrente(112, 245225424)
            };
            ...
            var contasOrdenada = contas.OrderBy(conta => {
                if (conta == null)
                {
                    return int.MaxValue;
                }
